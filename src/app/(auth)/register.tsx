...
import { Eye, EyeOff, Mail, Lock, User, Phone, ArrowLeft, CheckCircle2 } from 'lucide-react-native';
...
const styles = StyleSheet.create({
    ...
    checkboxChecked: { backgroundColor: '#5B21B6', borderColor: '#5B21B6' },
    termsText: { flex: 1, color: '#4B5563', fontSize: 14, lineHeight: 20 },
    termsLink: { color: '#5B21B6', fontWeight: '600' },
